...
public class AdminsController {
    ...
    public String printPresentation(Model model) {
        ...
        teamMembers.add(new TeamMember("Cristian", "Líder Técnico", "Java, Python", "Perfil: Motivado por el bienestar de los clientes y el trabajo en equipo ","/images/Cristian.png"));
