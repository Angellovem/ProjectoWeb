...
public class AdminsController {
    ...
    public String printPresentation(Model model) {
        ...
        teamMembers.add(new TeamMember("Angel", "CTO", "Go, TSX, Java, JS, Python", "Perfil: Una persona apasionada por el desarrollo de software y las lenguas.","/images/angel.jpg"));
